                ...
                <div>
                    ...
                    <div id="loginForm">
                        <form @submit.prevent="submitForm">
                            ...
                            <p>
                                <input name="password" class="w3-input" placeholder="비밀번호를 입력하세요." id="password" v-model="password" type="password">
                            </p>
                            <p>
                                <input name="password" class="w3-input" placeholder="비밀번호를 확인하세요." type="password">
                            </p>
                            <p>
                                <input class="w3-input" name="uid" placeholder="닉네임을 입력하세요." id="userName" v-model="userName"><br>
                            </p>
                            <p>
